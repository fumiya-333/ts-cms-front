<template>
  <FormTemplate>
    ...
    <TextPlane text-class="u-px2 u-py1 u-text-sz4"  :value="$v.form.name.$model" placeholder="浦島 太郎" @input="$v.form.name.$model = $event"></TextPlane>
...
export default Vue.extend({
  name: "CreatePrePage",
  components: { FormTemplate, FormLabel, TextEmail, CreatePreBtn, TextPassword, TextPlane },
  data(){
    return {
      form: {
        name: "",
